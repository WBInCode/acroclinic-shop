    ...
    return (
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    <div className="max-w-4xl mx-auto bg-[#111] border border-white/10 rounded-2xl shadow-2xl shadow-black/50 backdrop-blur-xl">
                        <div className="p-5 md:p-6">
                            ...
                            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6">
                                ...
                                <div className="flex items-center gap-3 flex-shrink-0 w-full md:w-auto">
                                    <button
                                        onClick={handleDecline}
                                        className="flex-1 md:flex-none px-5 py-2.5 text-white/50 hover:text-white/80 text-xs uppercase tracking-wider font-[family-name:var(--font-body)] transition-colors border border-white/10 hover:border-white/20 cursor-pointer rounded-xl"
                                    >
                                        Odrzuć
                                    </button>
                                    <button
                                        onClick={handleAccept}
                                        className="flex-1 md:flex-none px-5 py-2.5 bg-brand-gold hover:bg-brand-gold/80 text-black text-xs uppercase tracking-wider font-bold font-[family-name:var(--font-body)] transition-colors cursor-pointer rounded-xl"
                                    >
                                        Akceptuję
                                    </button>
                                </div>
